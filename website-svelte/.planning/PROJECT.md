...
- ✓ **Phase 1: Schema + Catalog** — Browsing by type, nested sidebar, image display, and initial Convex schema
- ✓ **Phase 2: Guest List Mode** — List CRUD, detail page management, bulk actions, and localStorage guest trial

### Active

- [ ] Guest data migrates to Convex on signup (Phase 3)
- [ ] Clerk authentication with login page (Phase 3)
- [ ] User profile page (name, bio, hobbies, picture) (Phase 4)
- [ ] Master Admin page — CRUD catalog items, bulk import (CSV/JSON), image management, type management (Phase 5)
